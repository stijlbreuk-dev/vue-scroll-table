<template>
  <div id="app">
    ...
    <p>
      A Vue table component with fully customizable cells (using scoped slots),
      a sticky first column, horizontal scrolling and pagination.
    </p>
    <scroll-table
      v-if="headers && rows"
      :headers="headers"
      ...
      :limits="[10, 25, 50, 100]"
    >
      <template slot="first name" slot-scope="{ data }">
